...
const Asistencia = () => {
  ...
  const [actividadesF, setActividadesF] = useState([]);
  ...
  const handleActividadCheck = (index) => {
    const updatedActividades = [...pacientes];
      ...
      <Container>
        ...
        <div className="row m-md-3 shadow mx-md-auto border-top-sm m-0 justify-content-center rounded container-lg ">
                ...
                <tr key={index}>
                  ...
                  <td>
                    <input
                      ...
                      value={element.id} // Usa el ID de la actividad como valor del checkbox
                      checked={element.checked} // Marca la actividad como seleccionada si está en el estado actividadesSeleccionadas
                  ...
                  <td>
                    ...
                    >
                      <span className="btn-text">Sí</span> {/* Texto añadido aquí */}
                    ...
                    >
                      <span className="btn-text">No</span> {/* Texto añadido aquí */}
                    </button>
                  </td>
                </tr>
              ))}
          ...
          <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-4" style={{ textAlign: 'center', paddingTop: 38 }}>
            <button type="button" className="btn btn-verde" style={{ width: '40%' }} onClick={() => guardarNuevo()}>Guardar</button> {/**implementar guardar */}
            <button type="button" className="btn btn-rojo" style={{ width: '40%', marginLeft: 10 }} onClick={() => clear()}>Cancelar</button>  {/**implementar eliminar */}
          </div>
        </div>
