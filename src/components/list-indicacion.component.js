...
import {
  retrieveIndicacionEp,
  createIndicacion,
  updateIndicacion,
  deleteIndicacion,
} from "../actions/indicacion";
...
class ListaIndicacion extends Component {
  ...
  eliminar(idindicacion) {
    this.props.deleteIndicacion(idindicacion).then(() => {
      this.props.retrieveIndicacionEp(this.props.idEpElegido);
    });
      ...
      >
        <div className="mb-4 col-12 col-md-9 col-lg-12 col-xl-10">
          ...
          <div className="row">
            ...
            <div
              className="mb-4 col-12 col-md-6 col-lg-6 col-xl-6"
                  ...
                  {indicaciones &&
                    indicaciones.map((indicacion, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          Cada{" "}
                          {this.convertirFormatoHora(indicacion.horadetoma)} hs
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <button
                            ...
                            className="btn btn-danger"
                            onClick={() =>
                              this.notificacionEliminar(indicacion.idindicacion)
                            }
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
