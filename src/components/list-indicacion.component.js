...
class ListaIndicacion extends React.Component {
            ...
            <form onSubmit={this.enviarFormulario.bind(this)}>
                <main className="border-top-sm m-0 row justify-content-center form-paciente m-md-3 rounded shadow container-lg mx-md-auto">
                    ...
                    <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-3">
                        ...
                        <input type="email" className="form-control" placeholder="Ingrese su Correo Electronico" id="email" aria-describedby="email" onChange={this.detectarCambio.bind(this, "email")} value={this.state.campo["email"] || ''}/>
                    </div>
                    <div className="w-100"></div>  
                    <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-3">
                        <label className="col-form-label">Contraseña</label>
                        <input type="password" className="form-control"  placeholder="Ingrese su Contraseña" id="pass" aria-describedby="pass" onChange={this.detectarCambio.bind(this, "pass")} value={this.state.campo["pass"] || ''}/>
                    </div>
                    <div className="w-100"></div>               
                        <button type="submit" className="mb-3 col-6 btn btn-primary col-md-3 col-xl-2" to >Iniciar Sesión</button>
                </main>
            </form>
        )
    }
