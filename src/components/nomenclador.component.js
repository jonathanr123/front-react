...
class Nomenclador extends Component {
    ...
    cancelar(){
        this.setState({show:false, showNuevo:true, show2:false, showNuevo2:true, campo:{enfermedad:"", medicamento:""}})
    }
    ...
    render() {
            const {show, showNuevo, show2, showNuevo2}=this.state;
            const {enfermedades, medicamentos} = this.props;
...
export default connect(mapStateToProps, { retrieveEnfermedad, createEnfermedad, updateEnfermedad, deleteEnfermedad, retrieveMedicamento, createMedicamento, updateMedicamento, deleteMedicamento  })(Nomenclador);