...
class ListaEvolucion extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            currentIndex:'',
            indexAgregar:6,
            arrayEnfermedades:[{id:1,enfermedad:'2',fecha:'05/09/2021'},{id:2,enfermedad:'3',fecha:'15/12/2018'},
                                {id:3,enfermedad:'1',fecha:'19/07/2011'},{id:4,enfermedad:'4',fecha:'17/02/2010'},
                                {id:5,enfermedad:'2',fecha:'05/07/2007'},{id:6,enfermedad:'3',fecha:'05/09/2005'},
                                ],
        ...
        return (
            <main className="border-top-sm m-0 row justify-content-center form-paciente m-md-3 rounded shadow container-lg mx-md-auto" style={{paddingTop:20}}>
                <div className="mb-4 col-12 col-md-9 col-lg-12 col-xl-10">
                    <h3 className="mt-4">Evolucion de Persona con EP</h3>
                <hr />
                ...
                <div className="border-top-sm m-0 row justify-content-center form-paciente m-md-3 rounded shadow container-lg mx-md-auto">
                    <h4 className="mt-4">Nueva Observacion</h4>
                    <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-3">
                        <label className="col-form-label">Estado Evolutivo</label>
                        <input type="text" className="form-control" placeholder="Ingrese enfermedad..." id="enfermedad" onChange={this.detectarCambio.bind(this, "enfermedad")}/>
                    </div>
                    <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-3">
                        <label className="col-form-label">Fecha de Observacion</label>
                        <input type="date" className="form-control" id="fecha" onChange={this.detectarCambio.bind(this, "fecha")}/>
                    </div>
                    <div className="mb-4 col-12 col-md-6 col-lg-4 col-xl-3" style={{textAlign:'center', paddingTop:38}}>
                ...
                <table className="table table-bordered table-hover shadow" style={{marginTop:10}}>
                <thead>
                    <tr>
                ...
                <tbody style={{verticalAlign:'middle'}}>
                    ...
                    {arrayEnfermedades &&
                                    arrayEnfermedades.map((enfermedad, index) => (
                                        <tr>
                                        <td>Estadio: {enfermedad.enfermedad}</td>
                                        <td>{enfermedad.fecha}</td>
                                        <td><button type="button" className="btn btn-success" style={{marginRight:10}} onClick={() => this.editar(enfermedad.enfermedad, enfermedad.fecha, index)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                <path fillRule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg>Editar</button>
                                            <button type="button" className="btn btn-danger" onClick={() => this.eliminar(enfermedad.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
